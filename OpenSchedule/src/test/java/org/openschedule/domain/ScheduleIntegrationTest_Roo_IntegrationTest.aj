...
import org.openschedule.domain.ScheduleDataOnDemand;
...
privileged aspect ScheduleIntegrationTest_Roo_IntegrationTest {
    ...
    public void ScheduleIntegrationTest.testCountSchedules() {
        ...
        long count = org.openschedule.domain.Schedule.countSchedules();
    ...
    public void ScheduleIntegrationTest.testFindSchedule() {
        org.openschedule.domain.Schedule obj = dod.getRandomSchedule();
        ...
        obj = org.openschedule.domain.Schedule.findSchedule(id);
    ...
    public void ScheduleIntegrationTest.testFindAllSchedules() {
        ...
        java.util.List<org.openschedule.domain.Schedule> result = org.openschedule.domain.Schedule.findAllSchedules();
    ...
    public void ScheduleIntegrationTest.testFindScheduleEntries() {
        ...
        java.util.List<org.openschedule.domain.Schedule> result = org.openschedule.domain.Schedule.findScheduleEntries(0, (int) count);
    ...
    public void ScheduleIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifySchedule(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.openschedule.domain.Schedule merged = (org.openschedule.domain.Schedule) obj.merge();
        obj.flush();
    ...
    public void ScheduleIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Schedule' failed to initialize correctly", dod.getRandomSchedule());
        org.openschedule.domain.Schedule obj = dod.getNewTransientSchedule(Integer.MAX_VALUE);
    ...
    public void ScheduleIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Schedule' with identifier '" + id + "'", org.openschedule.domain.Schedule.findSchedule(id));
    }
