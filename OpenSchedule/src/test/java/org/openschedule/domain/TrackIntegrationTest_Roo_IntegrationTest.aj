...
privileged aspect TrackIntegrationTest_Roo_IntegrationTest {
    ...
    public void TrackIntegrationTest.testCountTracks() {
        ...
        long count = org.openschedule.domain.Track.countTracks();
    ...
    public void TrackIntegrationTest.testFindTrack() {
        org.openschedule.domain.Track obj = dod.getRandomTrack();
        ...
        obj = org.openschedule.domain.Track.findTrack(id);
    ...
    public void TrackIntegrationTest.testFindAllTracks() {
        ...
        java.util.List<org.openschedule.domain.Track> result = org.openschedule.domain.Track.findAllTracks();
    ...
    public void TrackIntegrationTest.testFindTrackEntries() {
        ...
        java.util.List<org.openschedule.domain.Track> result = org.openschedule.domain.Track.findTrackEntries(0, (int) count);
    ...
    public void TrackIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyTrack(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.openschedule.domain.Track merged = (org.openschedule.domain.Track) obj.merge();
        obj.flush();
    ...
    public void TrackIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Track' failed to initialize correctly", dod.getRandomTrack());
        org.openschedule.domain.Track obj = dod.getNewTransientTrack(Integer.MAX_VALUE);
    ...
    public void TrackIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Track' with identifier '" + id + "'", org.openschedule.domain.Track.findTrack(id));
    }
