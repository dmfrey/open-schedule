...
privileged aspect UserController_Roo_Controller {
    ...
    public String UserController.create(@Valid UserAccount userAccount, BindingResult result, Model model, HttpServletRequest request) {
        if (result.hasErrors()) {
    ...
    public String UserController.update(@Valid UserAccount userAccount, BindingResult result, Model model, HttpServletRequest request) {
        if (result.hasErrors()) {
            model.addAttribute("userAccount", userAccount);
